...
export default {
  ...
  methods: {
    ...
    onPutIntButtonClicked(mode) {
      ESSharedDataManager.putInt("intKey", 11, mode)
        .then(value => {
    ...
    onPutLongButtonClicked(mode) {
      ESSharedDataManager.putLong("longKey", 11, mode)
        .then(value => {
    ...
    onPutStringButtonClicked(mode) {
      ESSharedDataManager.putString("stringKey", "11", mode)
        .then(value => {
    ...
    onPutArrayButtonClicked(mode) {
      ESSharedDataManager.putArray("arrayKey", [11], mode)
        .then(value => {
